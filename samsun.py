...
(function() {
    ...
    if (savedVersion && savedVersion !== BUILD_VERSION) {
        ...
        const bI = busIcon;
        const stopIcon = (n) => L.divIcon({ className: '', html: `<div style="width:14px;height:14px;background:#3b82f6;border-radius:50%;border:2px solid #fff;box-shadow:0 1px 4px rgba(0,0,0,.3)"></div>`, iconSize: [14, 14], iconAnchor: [7, 7] });
                        ...
                        x += `<div class="it pulse-it ${h.kat || 'otobus'}" onclick="shL('${encodeURIComponent(h.hat)}')" style="flex-direction:column;align-items:stretch;gap:4px;padding:10px 14px;cursor:pointer;margin-bottom:8px">
                            <div style="display:flex;align-items:center;width:100%;min-width:0;gap:8px">
                                ...
                                <div class="it-info" style="min-width:0;flex:1">
                                    <div class="it-title" style="white-space:nowrap;overflow:hidden;text-overflow:ellipsis;font-weight:700;font-size:14px">${h.ad}</div>
